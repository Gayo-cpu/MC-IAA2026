...
<head>
    ...
    <title>Contact Us - MCIAA Portal</title>
...
<body>
    ...
    <section class="contact-hero">
        <div class="hero-content">
            <h1>Get In Touch</h1>
            <p>Have questions about events, announcements, or community programs? Drop us a message below.</p>
        </div>
    </section>
    ...
    <main class="contact-wrapper">
        <div class="contact-grid">
            ...
            <!-- Left Side: Directory Information Card -->
            <div class="info-card">
                <h2>Community Hub</h2>
                <p class="info-intro">Reach out to the MCIAA management team or visit our office platform directly on campus.</p>
                <div class="info-links-stack">
                    <div class="info-item">
            ...
            <div class="form-card">
                ...
                <div id="formResponse" style="display:none; padding:12px 16px; border-radius:8px; margin-bottom:16px; font-weight:600;"></div>
                ...
                <form id="contactForm" class="contact-form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="email_address" name="email_address" required placeholder="name@example.com">
                        <span class="error-msg" id="emailError"></span>
                    </div>

                    <div class="form-group">
                        <label for="msg_subject">Subject</label>
                        <input type="text" id="msg_subject" name="msg_subject" required placeholder="What is this regarding?">
                        <span class="error-msg" id="subjectError"></span>
                    </div>

                    <div class="form-group">
                        <label for="user_message">Your Message</label>
                        <textarea id="user_message" name="user_message" rows="6" required placeholder="Type your message details here..."></textarea>
                        <span class="error-msg" id="messageError"></span>
                    </div>

                    <button type="submit" class="btn-gold-action" id="submitBtn">Send Message</button>
                </form>
            </div>
