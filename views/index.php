...
<body>
    ...
    <nav class="global-navbar">
        <div class="global-nav-container">
            <a href="index.php" class="global-nav-brand">
        ...
        <div class="hero-overlay">
            <div class="hero-text">
                ...
                <div class="hero-actions">
                    <a href="../views/register.php" class="btn-solid">Get Started</a>
                    <a href="../views/hifz.php" class="btn-outline">Explore Programs</a>
                </div>
            </div>
        </div>
    </section>
