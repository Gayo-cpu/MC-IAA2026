...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 29, 2026 at 10:04 PM
...
INSERT INTO `messages` (`message_id`, `sender_id`, `message_text`, `reply_text`, `replied_by`, `created_at`, `guest_name`, `guest_email`, `mobile_number`, `asked_for`, `is_answered`, `status`, `subject`, `replied_at`) VALUES
(1, 1, 'Naomba kufahamu taratibu za kisheria za ndoa mkataba.', NULL, NULL, '2026-06-14 09:19:46', NULL, NULL, NULL, 'imamu', 0, 0, NULL, NULL);
