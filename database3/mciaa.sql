...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 17, 2026 at 08:14 PM
...
INSERT INTO `donation` (`donation_id`, `user_id`, `amount`, `payment_method`, `transaction_reference`, `donation_date`, `donation_title`) VALUES
(1, 1, '50000.00', 'M-Pesa', 'MPK987654321', '2026-06-14 09:20:56', NULL);
...
(1, 1, '350000.00', 'ada ya mtihani', '2026-06-14 09:21:34', NULL, NULL);
...
--we have only five tables any changes to do
